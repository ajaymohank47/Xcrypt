...
<div style={{ display: 'flex', flexDirection: 'row', color: 'white', padding: '4px' }}>
  <h4 style={{ color: '#4c51bf', marginBottom: '2px' }}>Connect</h4>
  <a href="http://" style={{ marginLeft: '20px', color: 'white' }}>Discord</a>
  <a href="http://" style={{ marginLeft: '20px', color: 'white' }}>X/Twitter</a>
  <a href="http://" style={{ marginLeft: '20px', color: 'white' }}>Github</a>
</div>
  ...
  <div className="flex justify-center items-center flex-col mt-5">
    ...
    <p className="text-white text-sm text-center font-medium mt-2">Contact us at: ajaymohank47@gmail.com</p>
    <p className="text-white text-sm text-center font-medium mt-2">Customer care: 9004575835</p>
  </div>
